...
Main.exe: Main.o MyHuman.o SEIModel.o MyReadData.o CSVWriter.o MyModel.o
	$(MPICXX) -o $@ $^ -L/home/sara2204/sfw/boost-1_61_0/lib/ -L/home/sara2204/sfw/repast_hpc-2.3.1/lib/ -lrepast_hpc-2.3.1 -lboost_mpi-mt -lboost_serialization-mt -lboost_system-mt -lboost_filesystem-mt -lgdal
...
Main.o: Main.cpp
	$(MPICXX) $(REPAST_HPC_DEFINES) $(BOOST_INCLUDE) $(REPAST_HPC_INCLUDE) -I./include -c ./Main.cpp -o ./Main.o

#create a MyPatch.o file  everytime MyPatch.cpp or MyPatch.h changes
SEIModel.o: SEIModel.cpp SEIModel.h
	$(MPICXX) $(REPAST_HPC_DEFINES) $(BOOST_INCLUDE) $(REPAST_HPC_INCLUDE) -c SEIModel.cpp
	$(MPICXX) $(REPAST_HPC_DEFINES) $(BOOST_INCLUDE) $(REPAST_HPC_INCLUDE) -I./include -c ./SEIModel.cpp -o ./SEIModel.o

#create a Human.o file  everytime Human.cpp or Human.h changes

MyHuman.o: MyHuman.cpp MyHuman.h
	$(MPICXX) $(REPAST_HPC_DEFINES) $(BOOST_INCLUDE) $(REPAST_HPC_INCLUDE) -I./include -c ./MyHuman.cpp -o ./MyHuman.o


MyReadData.o: MyReadData.cpp MyReadData.h
	$(MPICXX) $(REPAST_HPC_DEFINES) $(BOOST_INCLUDE) $(REPAST_HPC_INCLUDE) -I./include -c ./MyReadData.cpp -o ./MyReadData.o 

CSVWriter.o: CSVWriter.cpp CSVWriter.h
	$(MPICXX) $(REPAST_HPC_DEFINES) $(BOOST_INCLUDE) $(REPAST_HPC_INCLUDE) -I./include -c ./CSVWriter.cpp -o ./CSVWriter.o
	
#create a Model.o file  everytime Model.cpp or Model.h changes
MyModel.o: MyModel.cpp MyModel.h
	$(MPICXX) $(REPAST_HPC_DEFINES) $(BOOST_INCLUDE) $(REPAST_HPC_INCLUDE) -I./include -c ./MyModel.cpp -o ./MyModel.o
